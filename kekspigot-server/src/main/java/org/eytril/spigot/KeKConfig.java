...
public class KeKConfig {
    ...
    public KeKConfig() {
        ...
        try {
            ...
            KeKBridge.version = (String) prop.getOrDefault("version", "Unknown");
        }
        ...
        this.config.options().header(KeKConfig.HEADER);
    ...
    private void loadConfig() {
        ...
        KeKBridge.disableOpPermissions = this.getBoolean("disable-op", true);
