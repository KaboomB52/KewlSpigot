...
public class CraftKnockbackProfile implements KnockbackProfile {
    ...
    public String[] getValues() {
        return new String[]{
                ChatColor.AQUA + "Horizontal Friction" + ChatColor.WHITE + ": " + this.horizontalFriction,
                ChatColor.AQUA + "Vertical Friction" + ChatColor.WHITE + ": " + this.verticalFriction,
    ...
    public void save() {
        ...
        KewlSpigot.INSTANCE.getConfig().set(path + ".horizontalfriction", this.horizontalFriction);
        KewlSpigot.INSTANCE.getConfig().set(path + ".verticalfriction", this.verticalFriction);
